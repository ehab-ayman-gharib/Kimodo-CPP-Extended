...
| **Hands crossing behind back (A-Pose)** | Downward walking motion compounding A-pose rest tilt. | Verify `Q_lift` is active and rotating rest arm vector to horizontal. |
