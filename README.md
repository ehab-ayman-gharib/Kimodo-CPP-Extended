...
- **Mixamo & Standard Humanoid**: In-place retargeting for T-Pose and A-Pose meshes with virtual angular compensation ($Q_{\text{lift}}$) and name-prefix agnosticism (`Hero_`, `Bear_Mama_`).
