...
# 3. Retarget SOMA Armature -> Mixamo Armature using Armature Bone Constraints
BONE_MAPPING = {
    "mixamorig:Hips": "Hips",
...
# Remove SOMA armature
bpy.data.objects.remove(soma_arm, do_unlink=True)

# Export FBX & GLB
output_glb = r"E:\Kimodo-CPP\demo-output\5e15f54638196203\Remy_armature_bake.glb"
bpy.ops.export_scene.gltf(
    filepath=output_glb,
    export_format='GLB',
    export_animations=True
)
print(f"Exported clean retargeted GLB to: {output_glb}")
