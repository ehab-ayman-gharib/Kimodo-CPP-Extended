...
output_glb = r"E:\Kimodo-CPP\demo-output\5e15f54638196203\Remy_similarity_test.glb"
output_fbx = r"E:\Kimodo-CPP\demo-output\5e15f54638196203\Remy_similarity_test.fbx"
...
# 2. Build SOMA Reference Armature to sample exact rest bases
...
# Precompute Basis Transformation Matrix M = R_mixamo_rest^-1 @ R_soma_rest for each bone
basis_transforms = {}
for mix_name, s_idx in BONE_MAPPING.items():
    ...
    if mix_name in char_arm.data.bones and soma_name in soma_arm.data.bones:
        ...
        # M maps from SOMA basis to Mixamo basis: M = m_rest.inverted() @ s_rest
...
print(f"Applying {num_frames} frames via Basis Similarity Transform...")
...
print(f"[SUCCESS] Similarity Transform Bake Exported:")
