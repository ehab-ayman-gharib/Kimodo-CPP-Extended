...
for mix_name, s_idx in BONE_MAPPING.items():
    ...
    if pb and mix_name in basis_transforms:
        ...
        # Apply absolute local quaternion directly in basis M
        pb.rotation_quaternion = M @ q_curr @ M.inverted()

bpy.context.view_layer.update()

print("\n--- POSE POSITIONS (DIRECT QUATERNION IN BASIS M) AT FRAME 105 ---")
