...
output_glb = r"E:\Kimodo-CPP\demo-output\5e15f54638196203\Remy_aligned_arms.glb"
output_fbx = r"E:\Kimodo-CPP\demo-output\5e15f54638196203\Remy_aligned_arms.fbx"
...
# 2. Build SOMA Armature with anatomically aligned rolls
...
for i, name in enumerate(SOMA30_NAMES):
    ...
    # Align bone rolls to SMPL-X canonical anatomical axes
...
print(f"Applying {num_frames} frames via Symmetrized Similarity Transform...")
...
for f in range(num_frames):
    ...
    for mix_name, s_idx in BONE_MAPPING.items():
        ...
        if pb and mix_name in basis_transforms:
            ...
            # Motion delta in SOMA local basis
...
print(f"[SUCCESS] Exported Aligned Arms Bake:")
